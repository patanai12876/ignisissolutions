  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white overflow-hidden mt-5 relative">
      ...
      <div className="relative z-10 animate-fadeIn">
        ...
        {/* HERO */}
        <section 
          className="container py-16 md:py-20 mt-10 text-center relative animate-slideUp"
        ...
        >
          ...
          <p 
            className="text-sm text-blue-400 mb-3 tracking-wide animate-slideDown relative z-20"
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-5 leading-tight relative z-20">
            We Design & Scale{" "}
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8 relative z-20">
            Ignisis Solutions helps companies grow with strategy, technology,
        ...
        {/* WHAT WE DO */}
        <section 
          className="container py-12 animate-slideUp"
          style={{ animationDelay: "0.3s" }}
        >
        ...
        {/* FEATURED PROJECT */}
        <section 
          className="container py-14 md:py-16 animate-slideUp border-t border-white/10"
        ...
        >
          ...
          <div className="max-w-2xl mx-auto text-center space-y-5">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              ...
              A professional copy trading platform serving 150K+ traders with
              real-time trade execution and advanced analytics.
        ...
        {/* CTA */}
        <section 
          className="text-center py-12 relative border-t border-white/10"
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-3 relative z-20">
            Let’s Build Something Impactful
          </h2>



          <p className="text-gray-400 mb-5 relative z-20">
