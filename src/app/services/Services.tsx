...
export default function Services() {
  ...
  className="mt-5 max-w-4xl text-4xl font-bold leading-[1.15] sm:text-5xl lg:text-6xl"
>
    ...
    Growing Businesses.
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
         {services.map(
  ({ id, slug, icon: Icon, title, tagline, color }, index) => (
    <motion.div
      key={id}
      initial={{ opacity: 0, y: 20 }}
    ...
    >
      <Link
        href={`/services/${slug}`}
        className={`group relative block overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br ${color} p-6 text-left transition hover:border-[#17A2C7]/50`}
      >
