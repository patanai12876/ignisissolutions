    ...
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-6">
      ...
      >
        ...
        <div className="hidden lg:block">
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-xl bg-[#17A2C7] px-5 py-2.5 text-sm font-medium text-white transition hover:-translate-y-0.5 hover:bg-[#48c4e0] hover:shadow-[0_8px_24px_rgba(23,162,199,0.3)]"
          >
            Get Free Audit
          </Link>
        </div>
      ...
      {open && (
        <div className="mx-auto max-w-7xl rounded-b-2xl border border-t-0 border-white/10 bg-[#0A1930]/95 px-5 py-5 backdrop-blur-xl lg:hidden">
          ...
          <Link
            href="/contact"
            className="mt-4 flex items-center justify-center rounded-xl bg-[#17A2C7] px-5 py-3 text-sm font-semibold text-white"
          >
            Get Free Audit
          </Link>
        </div>
